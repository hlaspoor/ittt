(function (exports, require) {
  ...
  exports.MCTSNode.prototype.selectChild = function (c) {
    ...
    for (var i = 0; i < this.children.length; i++) {
      ...
      var v = (1.0 * a.values[a.player - 1]) / (1 + a.count) + c * Math.sqrt(Math.log(1 + this.count) / (1 + a.count)) + Math.random() * 1e-6;
      if (sa == null || v > sv) {
        sa = a;
        sv = v;
      }
  ...
  exports.MCTSPlayer.prototype.startThinking = function (g) {
    ...
    if (!root.children) {
      root.children = g.allActions().map(function (a) {
        return new exports.MCTSNode(g, a);
      });
  ...
  exports.MCTSPlayer.prototype.continueThinking = function (state, nt) {
    ...
    for (var t = t0; t < t1; t++) {
      ...
      if (!tg.isGameOver()) {
        n.children = tg.allActions().map(function (a) {
          return new exports.MCTSNode(tg, a);
        });
        root.parentNodeCount += 1;
  ...
  typeof exports === "undefined" ? (this.exports_mcts = {}) : exports,
